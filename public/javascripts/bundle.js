...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#check').click(function (e) {
    console.log('クリックされた');
    e.preventDefault();
    var isbn = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#isbn").val();
    console.log(isbn);
    var url = "https://api.openbd.jp/v1/get?isbn=" + isbn;
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(url, function (data) {
      if (data[0] == null) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#thumbnail").html('<p>データがありませんフォームから本の情報を入力してください</p>');
        console.log('存在しないisbn');
      } else {
        if (data[0].summary.cover == "") {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#thumbnail").html('<p>画像データがありません<p>');
        } else {
          var photoUrl = data[0].summary.cover;
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#thumbnail").html('<img src=\"' + photoUrl + '\" style=\"border:solid 1px #000000\" />');
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#photoUrl").val(data[0].summary.cover);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#bookTitle").val(data[0].summary.title);
          // const str = data[0].summary.author;
          // const author = str.slice(0, -2);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#author").val(data[0].summary.author);
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#publisher").val(data[0].summary.publisher);
        }
      }
    });
  });
